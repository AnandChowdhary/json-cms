<?php
    ...
    function head($title) {
        ...
        echo '</ul> <ul class="nav navbar-nav navbar-right"> <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown">'.$_SESSION["admin"].' <span class="caret"></span></a> <ul class="dropdown-menu"><li><a href="../">Visit Website</a></li><li role="separator" class="divider"><li class="dropdown-header">Advanced</li><li><a href="editor.php">File Manager</a></li><li><a href="editor.php?file=data.json">JSON Datafile</a></li><li role="separator" class="divider"></li><li><a href="update.php">Updates</a></li><li><a href="logout.php">Users</a></li><li><a href="logout.php">Edit Password</a></li><li><a href="logout.php">Log out</a></li></ul> </li></ul> </div></div></nav> <div class="container">';
    }
